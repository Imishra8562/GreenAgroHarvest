...
namespace Web.Areas.Panel.Model
{
    public class MasterModel
    {
        ...
        public HttpPostedFileBase Banner_image { get; set; }
        #endregion
        #region About
        ...
        #endregion
        #region AboutDetails
        public AboutDetails AboutDetails_Obj { get; set; }
        public AboutDetails_Business AboutDetails_Business_Obj { get; set; }
        public IList<AboutDetails> List_AboutDetails_Obj { get; set; }
        public IList<AboutDetails_Business> List_AboutDetails_Business_Obj { get; set; }
        #endregion
        #region Status
        ...
        public HttpPostedFileBase BlogDetails_Image { get; set; }
        public HttpPostedFileBase BlogDetails_ImageA { get; set; }
        public HttpPostedFileBase BlogDetails_ImageB { get; set; }
        #endregion
        #region Gallery
        public Gallery Gallery_Obj { get; set; }
        public IList<Gallery> List_Gallery_Obj { get; set; }
        public HttpPostedFileBase Gallery_Image { get; set; }
        #endregion
        #region Services
        public Services Services_Obj { get; set; }
        public IList<Services> List_Services_Obj { get; set; }
        public HttpPostedFileBase Services_Image { get; set; }
        #endregion
    }
}